import types, { ASTNode } from "recast/lib/types";
import { parse } from "recast/lib/parser";
import { Options } from "recast/lib/options";
export interface Parser {
    parse(source: string, options?: any): ASTNode;
}
declare function print(node: ASTNode, options?: Options): import("recast/lib/printer").PrintResultType;
declare function prettyPrint(node: ASTNode, options?: Options): import("recast/lib/printer").PrintResultType;
...
export default main;
export { ASTNode, NamedTypes, Builders, NodePath, Type, } from "recast/lib/types";
